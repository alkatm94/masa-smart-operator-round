...
export default function AICameraScreen({
  ...
  useEffect(() => {
    try {
      ...
      worker.current.onmessage = (e) => {
        ...
        setSelected(
          (s: string | null) => s || e.data.detections[0]?.id || null,
        );
      };
    } catch {}
  ...
  const process = useCallback(() => {
    ...
    else setDetections(analyseGauge(image, cal));
  }, [paused, photo, settings.aiCameraEnabled, cal]);
  useEffect(() => {
  ...
  return (
    <div className="camera-screen">
      ...
      <div className="camera-stage">
        ...
        {settings.showBoundingBoxes && <VisionOverlay
